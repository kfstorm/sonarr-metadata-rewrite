...
<episodedetails>
  <title>Pilot</title>
  <plot>Walter White, a struggling high school chemistry teacher, is diagnosed with advanced lung cancer.</plot>
  <uniqueid type="tmdb" default="true">1396</uniqueid>
  <season>1</season>
  <episode>1</episode>
</episodedetails>
...
def test_kodi_format_extract_tmdb_ids_tvshow(temp_nfo_file):
...
def test_kodi_format_extract_tmdb_ids_episode(temp_nfo_file):
...
def test_kodi_format_extract_content(temp_nfo_file):
...
def test_kodi_format_write_translated_metadata(temp_nfo_file):
...
def test_kodi_format_supports_file(temp_nfo_file):
...
def test_emby_format_extract_tmdb_ids_series(temp_nfo_file):
...
def test_emby_format_extract_tmdb_ids_episode(temp_nfo_file):
...
def test_emby_format_extract_content_overview(temp_nfo_file):
...
def test_emby_format_extract_content_mixed(temp_nfo_file):
...
def test_emby_format_write_translated_metadata_overview(temp_nfo_file):
...
def test_emby_format_write_translated_metadata_plot_fallback(temp_nfo_file):
...
def test_emby_format_supports_file(temp_nfo_file):
...
def test_detect_metadata_format(temp_nfo_file):
...
def test_metadata_formats_registry():
